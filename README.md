...
Install this [Time Based One Time Password Authenticator](https://totp.morganism.dev) [PWA](https://en.wikipedia.org/wiki/Progressive_web_app) by clicking the ![install icon](/install_icon.png) in the address bar.    Google Authenticator, Authy compatible .. [Source Code](https://git.morganism.dev/totp)
...
<details>
  <summary>
	  29/06/2024 - Interesting Projects
  </summary>
...
<details>
  <summary>
	  30/04/2024 - Interesting Projects
  </summary>
...
![$\color{Red}{.}$](http://canarytokens.com/articles/traffic/0d7qg8vt3e95x8v6hyo761s4u/contact.php)
